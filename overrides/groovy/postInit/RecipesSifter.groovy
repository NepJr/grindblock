...
mods.gregtech.sifter.recipeBuilder()
                ...
                .chancedOutput(OrePrefix.dust, Materials.Gold, 750, 100)
                .EUt(8)
                .duration(100)
                .buildAndRegister()
...
mods.gregtech.sifter.recipeBuilder()
                ...
                .chancedOutput(OrePrefix.dust, Materials.Antimony, 500, 300)
                .chancedOutput(OrePrefix.dust, Materials.Lazurite, 400, 300)
                .chancedOutput(OrePrefix.dust, Materials.Molybdenum, 300, 300)
                .chancedOutput(OrePrefix.dust, Materials.GreenSapphire, 200, 300)
                .chancedOutput(OrePrefix.dust, Materials.NetherQuartz, 300, 300)
                .chancedOutput(OrePrefix.dust, Materials.Quartzite, 50, 300)
                .EUt(8)
                .duration(100)
                .buildAndRegister()